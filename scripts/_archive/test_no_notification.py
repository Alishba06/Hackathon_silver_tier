#!/usr/bin/env python3
"""
Test WITHOUT sending the initialized notification.
"""
...
print("=" * 70)
print("Test WITHOUT initialized notification")
print("=" * 70)
...
# SKIP Step 2 (no notification)

# Step 3: Navigate to Gmail
print("\n[2] Navigate to Gmail (NO notification sent)...")
nav_payload = {
    "jsonrpc": "2.0",
    "id": next_id(),
    "method": "tools/call",
